...
const Footer = () => {
  return (
    <div className="w-full h-screen p-20 flex felx-row gap-[9rem]">
        
        <div className="w-1/2 flex flex-col h-full justify-between FounderGrostesk">
           <div className="heading">
             <h1 className="text-[10vw] uppercase leading-none">EYE-<br/>OPENING</h1>
           </div>
           <>
        ...
        <div className="w-1/2 ">
         <h1 className="text-[6.5vw] FounderGrostesk font-semibold uppercase leading-none">
            Presentation
         </h1>
         <div className="details NeueMontreal mt-10">
